...
public class TouchkeysSensitivity extends DialogPreference implements OnClickListener {

    private static final String FILE_APPLY = "/sys/touchscreen/settings/set_write";

    private static final String FILE_PATH = "/sys/touchscreen/settings/set_keyarray";
    ...
    private static final int TITLE = R.string.touchkeys_sensitivity_seekbar_title;
    ...
    public TouchkeysSensitivity(Context context, AttributeSet attrs) {
        super(context, attrs);
